...
namespace AppSistemaMajor.Controllers
{
    ...
    public class SampleDataController : Controller
    {
        ...
        private static List<Dupla> ListaDeDuplas = new List<Dupla>
        {
           ...
           new Dupla(){ Number = "20", Word = "Nisi" },
           new Dupla(){ Number = "21", Word = "Nitro" },
           ...
           new Dupla(){ Number = "55", Word = "Lagarto" },
           ...
           new Dupla(){ Number = "66", Word = "Google" },
